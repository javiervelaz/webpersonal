    ...
    <div class="page-header clear-filter" filter-color="orange">
      ...
      <div class="container">
        <div class="photo-container">
          <img src="img/foto_javi.jpg" alt="" />
        </div>
        <h3 class="title">Javier Velazquez</h3>
        <p class="category">Desarrollador de software</p>
        <div class="content">
    ...
    <div class="section">
      <div class="container">
        <div class="button-container">
          ...
          <a
            href="https://www.linkedin.com/in/javier-vel%C3%A1zquez-45747015/"
          ...
          <a
            href="https://github.com/javiervelaz"
             target="_blank"
            class="btn btn-default btn-round btn-lg btn-icon"
            rel="tooltip"
